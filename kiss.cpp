...
Kiss::Kiss(int baud, int rxIndicationPin,  int txIndicationPin, int pttPin, int lowLevelSelectPin, int rxBufferSize, int txBufferSize) {
  _baud = baud;
  _hdlcTnc = new HdlcTnc(rxIndicationPin, txIndicationPin, pttPin, lowLevelSelectPin, rxBufferSize, txBufferSize);
}
